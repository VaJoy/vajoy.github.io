...
System.register("chunks:///_virtual/HomeComp.ts",["./rollupPluginModLoBabelHelpers.js","cc","./util.ts","./config.ts","./DemoComp.ts"],(function(t){var e,n,i,o,r,a,s,l,c,u,p,f,v,m,y,h;return{setters:[function(t){e=t.applyDecoratedDescriptor,n=t.inheritsLoose,i=t.initializerDefineProperty,o=t.assertThisInitialized},function(t){r=t.cclegacy,a=t._decorator,s=t.Prefab,l=t.find,c=t.Label,u=t.Node,p=t.instantiate,f=t.Component},function(t){v=t.getConfigList},function(t){m=t.version,y=t.demoList},function(t){h=t.DemoComp}],execute:function(){var C,d,g,L,b;r._RF.push({},"a7cc8LWO6JPLaUb6sAEZBo2","HomeComp",void 0);var B=a.ccclass,T=a.property;t("HomeComp",(C=B("HomeComp"),d=T({type:s}),C((b=e((L=function(t){function e(){for(var e,n=arguments.length,r=new Array(n),a=0;a<n;a++)r[a]=arguments[a];return e=t.call.apply(t,[this].concat(r))||this,i(e,"demoPrefab",b,o(e)),e.layout=null,e.revBtn=null,e.sortType=0,e}n(e,t);var r=e.prototype;return r.start=function(){this.layout=l("Canvas/ScrollView/view/Layout"),this.revBtn=l("Canvas/RevBtn"),l("Canvas/Title").getComponent(c).string="选择案例（v"+m+"，共"+y.length+"个）：",this.initList(),this.initRevBtn()},r.initRevBtn=function(){var t=this;this.revBtn.on(u.EventType.TOUCH_END,(function(){t.sortType=0===t.sortType?1:0,t.revBtn.getChildByName("Label").getComponent(c).string=0===t.sortType?"倒序":"正序",t.initList()}))},r.initList=function(){var t=this,e=v().concat();1===this.sortType&&e.reverse(),this.layout.removeAllChildren(),e.forEach((function(e){var n=p(t.demoPrefab);n.getComponent(h).init(e),t.layout.addChild(n)}))},e}(f)).prototype,"demoPrefab",[d],{configurable:!0,enumerable:!0,writable:!0,initializer:function(){return null}}),g=L))||g));r._RF.pop()}}}));
